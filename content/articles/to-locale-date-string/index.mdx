...
date: 2020-07-10T08:23:12-07:00
keywords:
  - javascript
---

import CodeSandbox from "components/CodeSandbox";
import { ISODate, LocaleDate } from "./components";
...
[Play with the live code at CodeSandbox][sandbox].

<CodeSandbox
  sandbox="tolocaledatestring-mn3ug"
  title="demo of toLocaleDateString"
  style={{ height: "min(30vh, 200px)" }}
/>
...
[sandbox]: https://codesandbox.io/s/tolocaledatestring-mn3ug
[tolocaledatestring]:
