...
<p>
  <Link to="/articles/workplace-justice-ally/">In a recent article</Link>, I
  talked about the issue of HR asking for personal pronouns. HR would like the
  data to be as consistent as possible, but the right thing to do is to allow
  people to enter whatever they want. Here's a possible implementation that
