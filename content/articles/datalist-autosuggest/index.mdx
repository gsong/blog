---
title: Using the HTML Data List Element for Simple Autosuggest
description: For simple autosuggest needs, give HTML a chance.
...
import Pronoun from "./helpers/Pronoun.js";
...
<CodeSandbox
  as="h4"
  sandbox="datalist-autosuggest-v1-nq0dz"
...
<CodeSandbox
  as="h4"
  sandbox="datalist-autosuggest-v2-rutk0"
  title="v1 demo of datalist"
/>
...
<CodeSandbox
  as="h4"
  sandbox="datalist-autosuggest-v3-hc8hr"
  title="v1 demo of datalist"
/>
...
<CodeSandbox
  as="h4"
  sandbox="datalist-autosuggest-v4-6ux86"
  title="v1 demo of datalist"
/>
...
- For auto suggestions or completions, try the built-in `<datalist>` element
  first.
...
enter anything they like. <Link to="/articles/workplace-justice-ally/">In a
recent article</Link>, I talked about the issue of HR asking for personal
pronouns. HR would like the data to be as consistent as possible, but the right
thing to do is to allow people to enter whatever they want. Here's a possible
implementation that fulfills both requirements:
